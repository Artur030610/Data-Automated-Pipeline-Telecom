...
def descargar_recaudacion(fecha_inicial_str: str, fecha_final_str: str):
    ...
    nombre_archivo = f"Data-HorasPago {f_ini.day}-{f_ini.month}-{f_ini.year} al {f_fin.day}-{f_fin.month}-{f_fin.year}.xlsx"
    
    user_profile = os.environ.get("USERPROFILE")
    ruta_destino = os.path.join(
        user_profile,
        "Documents", "A-DataStack", "01-Proyectos", "01-Data_PipelinesFibex", 
        "02_Data_Lake", "raw_data", "1-Recaudación", "1-Horas de pago",
        nombre_archivo
    )
