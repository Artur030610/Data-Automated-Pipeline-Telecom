...
def descargar_atc(fecha_inicial_str: str, fecha_final_str: str):
    ...
    nombre_archivo = f"Data - ATC {f_ini.day}-{f_ini.month}-{f_ini.year} al {f_fin.day}-{f_fin.month}-{f_fin.year}.xlsx"
    ...
    ruta_destino = os.path.join(
        ...
        "02_Data_Lake", "raw_data", "4-Atencion al Cliente", 
        nombre_archivo
    )
    ...
    with sync_playwright() as p:
        ...
        # ================== DESCARGA DIRECTA E INDEPENDIENTE ==================
...
if __name__ == "__main__":
    # Fechas de prueba
    descargar_atc("01/01/2026", "01/01/2026")